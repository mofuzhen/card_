...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"components/home/component/rewards.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $6d5e4a = exports.default || module.exports;
      
      if (typeof $6d5e4a === 'function') {
        $6d5e4a = $6d5e4a.options;
      }
    
        /* template */
        Object.assign($6d5e4a, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$6d5e4a', $6d5e4a);
          } else {
            api.reload('$6d5e4a', $6d5e4a);
          }
        }
